...
export function initArtistItemsPage() {
    ...
    function handleAddAndSaveBtn() {
        ...
        if (newItemImgUrlInputValue === '') {
            setError(newItemImgUrlInput, 'Field cannot be empty')
        }
        ...
        if (itemIdToEdit !== -1) {
            if (allGood) {
                ...
                itemsFromLocalStorage[itemIdToEdit].image = newItemImgUrlInputValue
